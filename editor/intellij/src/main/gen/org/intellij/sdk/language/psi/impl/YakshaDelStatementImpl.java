...
public class YakshaDelStatementImpl extends ASTWrapperPsiElement implements YakshaDelStatement {

  public YakshaDelStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public YakshaDelStatementWoIndent getDelStatementWoIndent() {
    return findNotNullChildByClass(YakshaDelStatementWoIndent.class);
  }
