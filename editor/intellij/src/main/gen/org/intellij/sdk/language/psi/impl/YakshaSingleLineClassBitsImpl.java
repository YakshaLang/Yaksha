...
public class YakshaSingleLineClassBitsImpl extends ASTWrapperPsiElement implements YakshaSingleLineClassBits {

  public YakshaSingleLineClassBitsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull YakshaVisitor visitor) {
    visitor.visitSingleLineClassBits(this);
  }
  ...
  public YakshaClassFieldWoIndent getClassFieldWoIndent() {
    return findChildByClass(YakshaClassFieldWoIndent.class);
  }
