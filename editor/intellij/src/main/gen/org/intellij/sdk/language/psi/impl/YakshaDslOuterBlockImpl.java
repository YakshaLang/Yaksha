...
public class YakshaDslOuterBlockImpl extends ASTWrapperPsiElement implements YakshaDslOuterBlock {

  public YakshaDslOuterBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull YakshaVisitor visitor) {
    visitor.visitDslOuterBlock(this);
  }
