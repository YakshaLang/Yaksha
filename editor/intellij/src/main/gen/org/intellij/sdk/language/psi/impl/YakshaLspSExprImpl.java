...
public class YakshaLspSExprImpl extends ASTWrapperPsiElement implements YakshaLspSExpr {

  public YakshaLspSExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull YakshaVisitor visitor) {
    visitor.visitLspSExpr(this);
  }
