...
public class YakshaDelStatementWoIndentImpl extends ASTWrapperPsiElement implements YakshaDelStatementWoIndent {

  public YakshaDelStatementWoIndentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull YakshaVisitor visitor) {
    visitor.visitDelStatementWoIndent(this);
  }
