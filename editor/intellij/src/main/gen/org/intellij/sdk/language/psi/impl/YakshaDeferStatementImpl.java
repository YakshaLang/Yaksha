...
public class YakshaDeferStatementImpl extends ASTWrapperPsiElement implements YakshaDeferStatement {

  public YakshaDeferStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public YakshaDeferStatementWoIndent getDeferStatementWoIndent() {
    return findNotNullChildByClass(YakshaDeferStatementWoIndent.class);
  }
