...
public class YakshaLispBodyImpl extends ASTWrapperPsiElement implements YakshaLispBody {

  public YakshaLispBodyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull YakshaVisitor visitor) {
    visitor.visitLispBody(this);
  }
