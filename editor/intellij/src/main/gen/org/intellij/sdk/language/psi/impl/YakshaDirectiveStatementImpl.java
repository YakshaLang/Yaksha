...
public class YakshaDirectiveStatementImpl extends ASTWrapperPsiElement implements YakshaDirectiveStatement {

  public YakshaDirectiveStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
