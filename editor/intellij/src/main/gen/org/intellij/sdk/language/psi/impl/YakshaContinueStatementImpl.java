...
public class YakshaContinueStatementImpl extends ASTWrapperPsiElement implements YakshaContinueStatement {

  public YakshaContinueStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
