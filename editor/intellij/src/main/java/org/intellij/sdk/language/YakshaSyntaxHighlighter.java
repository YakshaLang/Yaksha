...
public class YakshaSyntaxHighlighter extends SyntaxHighlighterBase {
    ...
    private static final Set<IElementType> YK_OPERATORS = ImmutableSet.<IElementType>builder()
            ...
            .add(YakshaTypes.OPERATOR_SHL)
            .add(YakshaTypes.OPERATOR_SHR)
            .add(YakshaTypes.OPERATOR_B_AND)
            .add(YakshaTypes.OPERATOR_B_OR)
            .add(YakshaTypes.OPERATOR_B_XOR)
            .add(YakshaTypes.OPERATOR_PLUS_EQ)
            .add(YakshaTypes.OPERATOR_MINUS_EQ)
            .add(YakshaTypes.OPERATOR_MUL_EQ)
            .add(YakshaTypes.OPERATOR_DIV_EQ)
            .add(YakshaTypes.OPERATOR_REMAINDER_EQ)
            .add(YakshaTypes.OPERATOR_SHL_EQ)
            .add(YakshaTypes.OPERATOR_SHR_EQ)
            .add(YakshaTypes.OPERATOR_B_AND_EQ)
