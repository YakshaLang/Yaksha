...
int32_t yy__main() 
{
    ...
    yk__sds t__3 = yk__sdsnew("v=");
    yk__printstr((t__3));
    yk__printlnint(((intmax_t)yy__v));
    yk__sds t__4 = yk__sdsnew("r=");
    yk__printstr((t__4));
    ...
    yk__sds t__5 = yk__sdsnew("Hello");
    yk__sds yy__s = yk__sdsdup(t__5);
    yk__sds t__6 = yk__sdsnew(" World");
    yy__s = yk__sdscatsds(yy__s, t__6);
