...
int32_t yy__main() 
{
    ...
    ;
    yk__hmput(yy__m, 1, 42);
    yk__hmput(yy__m, 100, 10000);
    yk__sds t__0 = yk__sdsnew("1 = ");
    yk__printstr((t__0));
    yk__printlnint(((intmax_t)yk__hmget(yy__m, 1)));
    ...
    yk__printstr((t__2));
    yk__printlnint(((intmax_t)yk__hmgeti(yy__m, 1)));
    yk__sds t__3 = yk__sdsnew("30 is located at = ");
    yk__printstr((t__3));
    yk__printlnint(((intmax_t)yk__hmgeti(yy__m, 30)));
    yk__hmfree(yy__m);
