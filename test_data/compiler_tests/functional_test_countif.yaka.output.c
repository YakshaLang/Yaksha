...
int32_t yy__main() 
{
    yk__sds t__0 = yk__sdsnew(">> countif str test <<");
    yk__printlnstr((t__0));
    ykfncptr0 yy__f = yy__keep_len_n;
    yk__sds t__1 = yk__sdsnew("Hello");
    yk__sds t__2 = yk__sdsnew("World");
    yk__sds t__3 = yk__sdsnew("How");
    yk__sds t__4 = yk__sdsnew("Are");
    yk__sds t__5 = yk__sdsnew("You");
    yk__sds* t__6 = NULL;
    ...
    yk__sds t__23 = yk__sdsnew(">> countif int test <<");
    ...
    yk__sds t__33 = yk__sdsnew("completed.");
