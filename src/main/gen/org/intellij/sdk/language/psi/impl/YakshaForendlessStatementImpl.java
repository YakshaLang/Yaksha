...
public class YakshaForendlessStatementImpl extends ASTWrapperPsiElement implements YakshaForendlessStatement {

  public YakshaForendlessStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull YakshaVisitor visitor) {
    visitor.visitForendlessStatement(this);
  }
