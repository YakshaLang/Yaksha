...
public class YakshaWhileBitsImpl extends ASTWrapperPsiElement implements YakshaWhileBits {

  public YakshaWhileBitsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull YakshaVisitor visitor) {
    visitor.visitWhileBits(this);
  }
  ...
  @Override
  @Nullable
  public YakshaDefBits getDefBits() {
    return findChildByClass(YakshaDefBits.class);
  }
