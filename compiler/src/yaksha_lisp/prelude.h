...
const std::string YAKSHA_LISP_PRELUDE = R"<><><><>(
    ...
    (def YK_TOKEN_KEYWORD_DECL 28967)
    (def YK_TOKEN_KEYWORD_DEF 28968)
    (def YK_TOKEN_KEYWORD_DEFER 28969)
    (def YK_TOKEN_KEYWORD_DEL 28970)
    (def YK_TOKEN_KEYWORD_DIRECTIVE 28971)
    (def YK_TOKEN_KEYWORD_ELIF 28972)
    (def YK_TOKEN_KEYWORD_ELSE 28973)
    (def YK_TOKEN_KEYWORD_ENUM 28974)
    (def YK_TOKEN_KEYWORD_FOR 28975)
    (def YK_TOKEN_KEYWORD_FROM 28976)
    (def YK_TOKEN_KEYWORD_IF 28977)
    (def YK_TOKEN_KEYWORD_IMPORT 28978)
    (def YK_TOKEN_KEYWORD_IN 28979)
    (def YK_TOKEN_KEYWORD_MACROS 28980)
    (def YK_TOKEN_KEYWORD_NOT 28981)
    (def YK_TOKEN_KEYWORD_OR 28982)
    (def YK_TOKEN_KEYWORD_PASS 28983)
    (def YK_TOKEN_KEYWORD_RETURN 28984)
    (def YK_TOKEN_KEYWORD_RUNTIMEFEATURE 28985)
    (def YK_TOKEN_KEYWORD_STRUCT 28986)
    (def YK_TOKEN_KEYWORD_TRY 28987)
    (def YK_TOKEN_KEYWORD_WHILE 28988)
    # =========== #
    #  Generating tokens
    # =========== #
    ...
    (defun ykt_keyword_decl () (yk_create_token YK_TOKEN_KEYWORD_DECL "decl"))
