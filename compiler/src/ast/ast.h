...
struct compins_stmt : stmt {
  compins_stmt(token* name, ykdatatype* data_type, token* meta1, ykdatatype* meta2, void* meta3);
  void accept(stmt_visitor *v) override;
  ast_type get_type() override;
  token* name_;
...
struct def_stmt : stmt {
  def_stmt(token* name, std::vector<parameter> params, stmt* function_body, ykdatatype* return_type, annotations annotations);
  void accept(stmt_visitor *v) override;
  ast_type get_type() override;
  token* name_;
...
struct foreach_stmt : stmt {
  foreach_stmt(token* for_keyword, token* name, ykdatatype* data_type, token* in_keyword, expr* expression, stmt* for_body);
  void accept(stmt_visitor *v) override;
  ast_type get_type() override;
  token* for_keyword_;
  token* name_;
...
struct nativeconst_stmt : stmt {
  nativeconst_stmt(token* name, ykdatatype* data_type, token* ccode_keyword, token* code_str);
  void accept(stmt_visitor *v) override;
  ast_type get_type() override;
  token* name_;
  ykdatatype* data_type_;
...
struct ast_pool {
  ...
  stmt *c_compins_stmt(token* name, ykdatatype* data_type, token* meta1, ykdatatype* meta2, void* meta3);
  stmt *c_const_stmt(token* name, ykdatatype* data_type, expr* expression);
  stmt *c_continue_stmt(token* continue_token);
  stmt *c_def_stmt(token* name, std::vector<parameter> params, stmt* function_body, ykdatatype* return_type, annotations annotations);
  ...
  stmt *c_foreach_stmt(token* for_keyword, token* name, ykdatatype* data_type, token* in_keyword, expr* expression, stmt* for_body);
  ...
  stmt *c_nativeconst_stmt(token* name, ykdatatype* data_type, token* ccode_keyword, token* code_str);
