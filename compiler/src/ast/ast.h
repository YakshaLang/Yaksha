...
struct assign_expr : expr {
  assign_expr(token* name, token* opr, expr* right, bool promoted, yk_datatype* promoted_data_type);
  void accept(expr_visitor *v) override;
  ast_type get_type() override;
  token* locate() override;
  nlohmann::json to_json() override;
  static assign_expr* from_json(const nlohmann::json& j, ast_pool* pool);
  token* name_;
  token* opr_;
  expr* right_;
  bool promoted_;
...
struct assign_arr_expr : expr {
  ...
  token* locate() override;
  nlohmann::json to_json() override;
  static assign_arr_expr* from_json(const nlohmann::json& j, ast_pool* pool);
  expr* assign_oper_;
  token* opr_;
  expr* right_;
};
struct assign_member_expr : expr {
  ...
  token* locate() override;
  nlohmann::json to_json() override;
  static assign_member_expr* from_json(const nlohmann::json& j, ast_pool* pool);
  expr* set_oper_;
  token* opr_;
  expr* right_;
};
struct binary_expr : expr {
  ...
  token* locate() override;
  nlohmann::json to_json() override;
  static binary_expr* from_json(const nlohmann::json& j, ast_pool* pool);
  expr* left_;
  token* opr_;
  expr* right_;
};
struct curly_call_expr : expr {
  ...
  token* locate() override;
  nlohmann::json to_json() override;
  static curly_call_expr* from_json(const nlohmann::json& j, ast_pool* pool);
  expr* dt_expr_;
  token* curly_open_;
...
struct fncall_expr : expr {
  ...
  token* locate() override;
  nlohmann::json to_json() override;
  static fncall_expr* from_json(const nlohmann::json& j, ast_pool* pool);
  expr* name_;
  token* paren_token_;
...
struct get_expr : expr {
  ...
  token* locate() override;
  nlohmann::json to_json() override;
  static get_expr* from_json(const nlohmann::json& j, ast_pool* pool);
  expr* lhs_;
  token* dot_;
  token* item_;
};
struct grouping_expr : expr {
  ...
  token* locate() override;
  nlohmann::json to_json() override;
  static grouping_expr* from_json(const nlohmann::json& j, ast_pool* pool);
  expr* expression_;
};
struct literal_expr : expr {
  ...
  token* locate() override;
  nlohmann::json to_json() override;
  static literal_expr* from_json(const nlohmann::json& j, ast_pool* pool);
...
struct logical_expr : expr {
  ...
  token* locate() override;
  nlohmann::json to_json() override;
  static logical_expr* from_json(const nlohmann::json& j, ast_pool* pool);
  expr* left_;
  token* opr_;
  expr* right_;
};
struct macro_call_expr : expr {
  macro_call_expr(token* path, token* name, token* not_symbol_tok, token* paren_token, std::vector<expr*> args, token* close_paren_token);
  void accept(expr_visitor *v) override;
  ast_type get_type() override;
  token* locate() override;
  nlohmann::json to_json() override;
  static macro_call_expr* from_json(const nlohmann::json& j, ast_pool* pool);
  token* path_;
  token* name_;
...
struct set_expr : expr {
  ...
  token* locate() override;
  nlohmann::json to_json() override;
  static set_expr* from_json(const nlohmann::json& j, ast_pool* pool);
  expr* lhs_;
  token* dot_;
  token* item_;
};
struct square_bracket_access_expr : expr {
  ...
  token* locate() override;
  nlohmann::json to_json() override;
  static square_bracket_access_expr* from_json(const nlohmann::json& j, ast_pool* pool);
  expr* name_;
  token* sqb_token_;
  expr* index_expr_;
};
struct square_bracket_set_expr : expr {
  ...
  token* locate() override;
  nlohmann::json to_json() override;
  static square_bracket_set_expr* from_json(const nlohmann::json& j, ast_pool* pool);
  expr* name_;
  token* sqb_token_;
  expr* index_expr_;
};
struct unary_expr : expr {
  ...
  token* locate() override;
  nlohmann::json to_json() override;
  static unary_expr* from_json(const nlohmann::json& j, ast_pool* pool);
  token* opr_;
  expr* right_;
};
struct variable_expr : expr {
  ...
  token* locate() override;
  nlohmann::json to_json() override;
  static variable_expr* from_json(const nlohmann::json& j, ast_pool* pool);
  token* name_;
};
// ------- statements ------
struct block_stmt : stmt {
  ...
  token* locate() override;
  nlohmann::json to_json() override;
  static block_stmt* from_json(const nlohmann::json& j, ast_pool* pool);
...
struct break_stmt : stmt {
  ...
  token* locate() override;
  nlohmann::json to_json() override;
  static break_stmt* from_json(const nlohmann::json& j, ast_pool* pool);
  token* break_token_;
};
struct ccode_stmt : stmt {
  ...
  token* locate() override;
  nlohmann::json to_json() override;
  static ccode_stmt* from_json(const nlohmann::json& j, ast_pool* pool);
  token* ccode_keyword_;
  token* code_str_;
};
struct cfor_stmt : stmt {
  cfor_stmt(token* for_keyword, token* open_paren, expr* init_expr, token* semi1, expr* comparison, token* semi2, expr* operation, token* close_paren, stmt* for_body);
  void accept(stmt_visitor *v) override;
  ast_type get_type() override;
  token* locate() override;
  nlohmann::json to_json() override;
  static cfor_stmt* from_json(const nlohmann::json& j, ast_pool* pool);
  token* for_keyword_;
  token* open_paren_;
  expr* init_expr_;
  token* semi1_;
...
struct class_stmt : stmt {
  class_stmt(token* name, std::vector<parameter> members, annotations annotations);
  void accept(stmt_visitor *v) override;
  ast_type get_type() override;
  token* locate() override;
  nlohmann::json to_json() override;
  static class_stmt* from_json(const nlohmann::json& j, ast_pool* pool);
  token* name_;
  std::vector<parameter> members_;
  annotations annotations_;
};
struct compins_stmt : stmt {
  compins_stmt(token* name, yk_datatype* data_type, token* meta1, yk_datatype* meta2, void* meta3);
  void accept(stmt_visitor *v) override;
  ast_type get_type() override;
  token* locate() override;
  nlohmann::json to_json() override;
  static compins_stmt* from_json(const nlohmann::json& j, ast_pool* pool);
  token* name_;
...
struct const_stmt : stmt {
  const_stmt(token* name, yk_datatype* data_type, expr* expression, bool is_global);
  void accept(stmt_visitor *v) override;
  ast_type get_type() override;
  token* locate() override;
  nlohmann::json to_json() override;
  static const_stmt* from_json(const nlohmann::json& j, ast_pool* pool);
  token* name_;
  yk_datatype* data_type_;
  expr* expression_;
  bool is_global_;
...
struct continue_stmt : stmt {
  ...
  token* locate() override;
  nlohmann::json to_json() override;
  static continue_stmt* from_json(const nlohmann::json& j, ast_pool* pool);
...
struct decl_stmt : stmt {
  ...
  token* locate() override;
  nlohmann::json to_json() override;
  static decl_stmt* from_json(const nlohmann::json& j, ast_pool* pool);
  token* decl_token_;
  token* name_;
  std::vector<token*> replacement_;
};
struct def_stmt : stmt {
  def_stmt(token* name, std::vector<parameter> params, stmt* function_body, yk_datatype* return_type, annotations annotations);
  void accept(stmt_visitor *v) override;
  ast_type get_type() override;
  token* locate() override;
  nlohmann::json to_json() override;
  static def_stmt* from_json(const nlohmann::json& j, ast_pool* pool);
  token* name_;
...
struct defer_stmt : stmt {
  ...
  token* locate() override;
  nlohmann::json to_json() override;
  static defer_stmt* from_json(const nlohmann::json& j, ast_pool* pool);
...
struct del_stmt : stmt {
  ...
  token* locate() override;
  nlohmann::json to_json() override;
  static del_stmt* from_json(const nlohmann::json& j, ast_pool* pool);
  token* del_keyword_;
  expr* expression_;
};
struct directive_stmt : stmt {
  directive_stmt(token* directive_token, std::vector<parameter> values, token* directive_type, token* directive_val);
  void accept(stmt_visitor *v) override;
  ast_type get_type() override;
  token* locate() override;
  nlohmann::json to_json() override;
  static directive_stmt* from_json(const nlohmann::json& j, ast_pool* pool);
...
struct dsl_macro_stmt : stmt {
  dsl_macro_stmt(token* name, token* name2, token* not_symbol_tok, token* curly_open, std::vector<token*> internal_soup, token* curly_close);
  void accept(stmt_visitor *v) override;
  ast_type get_type() override;
  token* locate() override;
  nlohmann::json to_json() override;
  static dsl_macro_stmt* from_json(const nlohmann::json& j, ast_pool* pool);
  token* name_;
  token* name2_;
  token* not_symbol_tok_;
  token* curly_open_;
...
struct elif_stmt : stmt {
  ...
  token* locate() override;
  nlohmann::json to_json() override;
  static elif_stmt* from_json(const nlohmann::json& j, ast_pool* pool);
  token* elif_keyword_;
  expr* expression_;
  stmt* elif_branch_;
};
struct enum_stmt : stmt {
  enum_stmt(token* name, std::vector<parameter> members, annotations annotations);
  void accept(stmt_visitor *v) override;
  ast_type get_type() override;
  token* locate() override;
  nlohmann::json to_json() override;
  static enum_stmt* from_json(const nlohmann::json& j, ast_pool* pool);
  token* name_;
  std::vector<parameter> members_;
  annotations annotations_;
};
struct expression_stmt : stmt {
  ...
  token* locate() override;
  nlohmann::json to_json() override;
  static expression_stmt* from_json(const nlohmann::json& j, ast_pool* pool);
  expr* expression_;
};
struct foreach_stmt : stmt {
  foreach_stmt(token* for_keyword, token* name, yk_datatype* data_type, token* in_keyword, expr* expression, stmt* for_body, yk_datatype* expr_datatype);
  void accept(stmt_visitor *v) override;
  ast_type get_type() override;
  token* locate() override;
  nlohmann::json to_json() override;
  static foreach_stmt* from_json(const nlohmann::json& j, ast_pool* pool);
  token* for_keyword_;
  token* name_;
  yk_datatype* data_type_;
  token* in_keyword_;
...
struct forendless_stmt : stmt {
  ...
  token* locate() override;
  nlohmann::json to_json() override;
  static forendless_stmt* from_json(const nlohmann::json& j, ast_pool* pool);
  token* for_keyword_;
  stmt* for_body_;
};
struct if_stmt : stmt {
  ...
  token* locate() override;
  nlohmann::json to_json() override;
  static if_stmt* from_json(const nlohmann::json& j, ast_pool* pool);
  token* if_keyword_;
  expr* expression_;
  stmt* if_branch_;
  token* else_keyword_;
...
struct import_stmt : stmt {
  import_stmt(token* import_token, std::vector<token*> import_names, token* name, file_info* data);
  void accept(stmt_visitor *v) override;
  ast_type get_type() override;
  token* locate() override;
  nlohmann::json to_json() override;
  static import_stmt* from_json(const nlohmann::json& j, ast_pool* pool);
  token* import_token_;
...
struct let_stmt : stmt {
  ...
  token* locate() override;
  nlohmann::json to_json() override;
  static let_stmt* from_json(const nlohmann::json& j, ast_pool* pool);
  token* name_;
  yk_datatype* data_type_;
  expr* expression_;
};
struct macros_stmt : stmt {
  macros_stmt(token* macros_token, token* not_symbol_tok, token* curly_open, std::vector<token*> lisp_code, token* curly_close);
  void accept(stmt_visitor *v) override;
  ast_type get_type() override;
  token* locate() override;
  nlohmann::json to_json() override;
  static macros_stmt* from_json(const nlohmann::json& j, ast_pool* pool);
  token* macros_token_;
  token* not_symbol_tok_;
  token* curly_open_;
...
struct nativeconst_stmt : stmt {
  nativeconst_stmt(token* name, yk_datatype* data_type, token* ccode_keyword, token* code_str, bool is_global);
  void accept(stmt_visitor *v) override;
  ast_type get_type() override;
  token* locate() override;
  nlohmann::json to_json() override;
  static nativeconst_stmt* from_json(const nlohmann::json& j, ast_pool* pool);
  token* name_;
  yk_datatype* data_type_;
  token* ccode_keyword_;
  token* code_str_;
...
struct pass_stmt : stmt {
  ...
  token* locate() override;
  nlohmann::json to_json() override;
  static pass_stmt* from_json(const nlohmann::json& j, ast_pool* pool);
  token* pass_token_;
};
struct return_stmt : stmt {
  return_stmt(token* return_keyword, expr* expression, yk_datatype* result_type);
  void accept(stmt_visitor *v) override;
  ast_type get_type() override;
  token* locate() override;
  nlohmann::json to_json() override;
  static return_stmt* from_json(const nlohmann::json& j, ast_pool* pool);
...
struct runtimefeature_stmt : stmt {
  ...
  token* locate() override;
  nlohmann::json to_json() override;
  static runtimefeature_stmt* from_json(const nlohmann::json& j, ast_pool* pool);
...
struct token_soup_stmt : stmt {
  ...
  token* locate() override;
  nlohmann::json to_json() override;
  static token_soup_stmt* from_json(const nlohmann::json& j, ast_pool* pool);
...
struct while_stmt : stmt {
  ...
  token* locate() override;
  nlohmann::json to_json() override;
  static while_stmt* from_json(const nlohmann::json& j, ast_pool* pool);
...
struct ast_pool {
  ast_pool();
  ~ast_pool();
  expr *c_assign_expr(token* name, token* opr, expr* right, bool promoted, yk_datatype* promoted_data_type);
  ...
  expr *c_macro_call_expr(token* path, token* name, token* not_symbol_tok, token* paren_token, std::vector<expr*> args, token* close_paren_token);
  ...
  stmt *c_cfor_stmt(token* for_keyword, token* open_paren, expr* init_expr, token* semi1, expr* comparison, token* semi2, expr* operation, token* close_paren, stmt* for_body);
  stmt *c_class_stmt(token* name, std::vector<parameter> members, annotations annotations);
  stmt *c_compins_stmt(token* name, yk_datatype* data_type, token* meta1, yk_datatype* meta2, void* meta3);
  stmt *c_const_stmt(token* name, yk_datatype* data_type, expr* expression, bool is_global);
  stmt *c_continue_stmt(token* continue_token);
  stmt *c_decl_stmt(token* decl_token, token* name, std::vector<token*> replacement);
  stmt *c_def_stmt(token* name, std::vector<parameter> params, stmt* function_body, yk_datatype* return_type, annotations annotations);
  stmt *c_defer_stmt(token* defer_keyword, expr* expression, stmt* del_statement);
  stmt *c_del_stmt(token* del_keyword, expr* expression);
  stmt *c_directive_stmt(token* directive_token, std::vector<parameter> values, token* directive_type, token* directive_val);
  stmt *c_dsl_macro_stmt(token* name, token* name2, token* not_symbol_tok, token* curly_open, std::vector<token*> internal_soup, token* curly_close);
  stmt *c_elif_stmt(token* elif_keyword, expr* expression, stmt* elif_branch);
  stmt *c_enum_stmt(token* name, std::vector<parameter> members, annotations annotations);
  stmt *c_expression_stmt(expr* expression);
  stmt *c_foreach_stmt(token* for_keyword, token* name, yk_datatype* data_type, token* in_keyword, expr* expression, stmt* for_body, yk_datatype* expr_datatype);
  ...
  stmt *c_import_stmt(token* import_token, std::vector<token*> import_names, token* name, file_info* data);
  stmt *c_let_stmt(token* name, yk_datatype* data_type, expr* expression);
  stmt *c_macros_stmt(token* macros_token, token* not_symbol_tok, token* curly_open, std::vector<token*> lisp_code, token* curly_close);
  stmt *c_nativeconst_stmt(token* name, yk_datatype* data_type, token* ccode_keyword, token* code_str, bool is_global);
  stmt *c_pass_stmt(token* pass_token);
  stmt *c_return_stmt(token* return_keyword, expr* expression, yk_datatype* result_type);
