...
static inline std::string token_to_str(const token_type &t) {
  if (t == token_type::AND)
    return "AND";
  if (t == token_type::AND_EQ)
    return "AND_EQ";
  if (t == token_type::ARROW)
    return "ARROW";
  if (t == token_type::AT)
    return "AT";
  if (t == token_type::BA_DEDENT)
    return "BA_DEDENT";
  if (t == token_type::BA_INDENT)
    return "BA_INDENT";
  ...
  if (t == token_type::COMMENT)
    return "COMMENT";
  if (t == token_type::CURLY_BRACKET_CLOSE)
    return "CURLY_BRACKET_CLOSE";
  if (t == token_type::CURLY_BRACKET_OPEN)
    return "CURLY_BRACKET_OPEN";
  if (t == token_type::DIV)
    return "DIV";
  if (t == token_type::DIV_EQ)
    return "DIV_EQ";
  if (t == token_type::DOT)
    return "DOT";
  if (t == token_type::DOUBLE_NUMBER)
    return "DOUBLE_NUMBER";
  if (t == token_type::ELLIPSIS)
    return "ELLIPSIS";
  if (t == token_type::END_OF_FILE)
    return "END_OF_FILE";
  if (t == token_type::EQ)
    return "EQ";
  if (t == token_type::EQ_EQ)
    return "EQ_EQ";
  if (t == token_type::FLOAT_NUMBER)
    return "FLOAT_NUMBER";
  if (t == token_type::GREAT)
    return "GREAT";
  if (t == token_type::GREAT_EQ)
    return "GREAT_EQ";
  if (t == token_type::INDENT)
    return "INDENT";
  if (t == token_type::INTEGER_BIN)
    return "INTEGER_BIN";
  if (t == token_type::INTEGER_BIN_16)
    return "INTEGER_BIN_16";
  if (t == token_type::INTEGER_BIN_64)
    return "INTEGER_BIN_64";
  if (t == token_type::INTEGER_BIN_8)
    return "INTEGER_BIN_8";
  if (t == token_type::INTEGER_DECIMAL)
    return "INTEGER_DECIMAL";
  if (t == token_type::INTEGER_DECIMAL_16)
    return "INTEGER_DECIMAL_16";
  if (t == token_type::INTEGER_DECIMAL_64)
    return "INTEGER_DECIMAL_64";
  if (t == token_type::INTEGER_DECIMAL_8)
    return "INTEGER_DECIMAL_8";
  if (t == token_type::INTEGER_HEX)
    return "INTEGER_HEX";
  if (t == token_type::INTEGER_HEX_16)
    return "INTEGER_HEX_16";
  if (t == token_type::INTEGER_HEX_64)
    return "INTEGER_HEX_64";
  if (t == token_type::INTEGER_HEX_8)
    return "INTEGER_HEX_8";
  if (t == token_type::INTEGER_OCT)
    return "INTEGER_OCT";
  if (t == token_type::INTEGER_OCT_16)
    return "INTEGER_OCT_16";
  if (t == token_type::INTEGER_OCT_64)
    return "INTEGER_OCT_64";
  if (t == token_type::INTEGER_OCT_8)
    return "INTEGER_OCT_8";
  if (t == token_type::INT_DIV)
    return "INT_DIV";
  if (t == token_type::INT_DIV_EQ)
    return "INT_DIV_EQ";
  if (t == token_type::LESS)
    return "LESS";
  if (t == token_type::LESS_EQ)
    return "LESS_EQ";
  if (t == token_type::MOD)
    return "MOD";
  if (t == token_type::MOD_EQ)
    return "MOD_EQ";
  if (t == token_type::MUL)
    return "MUL";
  if (t == token_type::MUL_EQ)
    return "MUL_EQ";
  if (t == token_type::NAME)
    return "NAME";
  if (t == token_type::NEW_LINE)
    return "NEW_LINE";
  if (t == token_type::NOT_EQ)
    return "NOT_EQ";
  if (t == token_type::NOT_SYMBOL)
    return "NOT_SYMBOL";
  if (t == token_type::OR)
    return "OR";
  if (t == token_type::OR_EQ)
    return "OR_EQ";
  if (t == token_type::PAREN_CLOSE)
    return "PAREN_CLOSE";
  if (t == token_type::PAREN_OPEN)
    return "PAREN_OPEN";
  if (t == token_type::PLUS)
    return "PLUS";
  if (t == token_type::PLUS_EQ)
    return "PLUS_EQ";
  if (t == token_type::POWER)
    return "POWER";
  if (t == token_type::POWER_EQ)
    return "POWER_EQ";
  if (t == token_type::SEMICOLON)
    return "SEMICOLON";
  if (t == token_type::SHL)
    return "SHL";
  if (t == token_type::SHL_EQ)
    return "SHL_EQ";
  if (t == token_type::SHR)
    return "SHR";
  if (t == token_type::SHR_EQ)
    return "SHR_EQ";
  if (t == token_type::SQUARE_BRACKET_CLOSE)
    return "SQUARE_BRACKET_CLOSE";
  if (t == token_type::SQUARE_BRACKET_OPEN)
    return "SQUARE_BRACKET_OPEN";
  if (t == token_type::STRING)
    return "STRING";
  if (t == token_type::SUB)
    return "SUB";
  if (t == token_type::SUB_EQ)
    return "SUB_EQ";
  if (t == token_type::THREE_QUOTE_STRING)
    return "THREE_QUOTE_STRING";
  if (t == token_type::TILDE)
    return "TILDE";
  if (t == token_type::UINTEGER_BIN)
    return "UINTEGER_BIN";
  if (t == token_type::UINTEGER_BIN_16)
    return "UINTEGER_BIN_16";
  if (t == token_type::UINTEGER_BIN_64)
    return "UINTEGER_BIN_64";
  if (t == token_type::UINTEGER_BIN_8)
    return "UINTEGER_BIN_8";
  if (t == token_type::UINTEGER_DECIMAL)
    return "UINTEGER_DECIMAL";
  if (t == token_type::UINTEGER_DECIMAL_16)
    return "UINTEGER_DECIMAL_16";
  if (t == token_type::UINTEGER_DECIMAL_64)
    return "UINTEGER_DECIMAL_64";
  if (t == token_type::UINTEGER_DECIMAL_8)
    return "UINTEGER_DECIMAL_8";
  if (t == token_type::UINTEGER_HEX)
    return "UINTEGER_HEX";
  if (t == token_type::UINTEGER_HEX_16)
    return "UINTEGER_HEX_16";
  if (t == token_type::UINTEGER_HEX_64)
    return "UINTEGER_HEX_64";
  if (t == token_type::UINTEGER_HEX_8)
    return "UINTEGER_HEX_8";
  if (t == token_type::UINTEGER_OCT)
    return "UINTEGER_OCT";
  if (t == token_type::UINTEGER_OCT_16)
    return "UINTEGER_OCT_16";
  if (t == token_type::UINTEGER_OCT_64)
    return "UINTEGER_OCT_64";
  if (t == token_type::UINTEGER_OCT_8)
    return "UINTEGER_OCT_8";
  if (t == token_type::UNKNOWN_BIN)
    return "UNKNOWN_BIN";
  if (t == token_type::UNKNOWN_DECIMAL)
    return "UNKNOWN_DECIMAL";
  if (t == token_type::UNKNOWN_HEX)
    return "UNKNOWN_HEX";
  if (t == token_type::UNKNOWN_OCT)
    return "UNKNOWN_OCT";
  if (t == token_type::XOR)
    return "XOR";
  if (t == token_type::XOR_EQ)
    return "XOR_EQ";
  if (t == token_type::KEYWORD_FALSE)
    return "KEYWORD_FALSE";
  if (t == token_type::KEYWORD_NONE)
    return "KEYWORD_NONE";
  if (t == token_type::KEYWORD_TRUE)
    return "KEYWORD_TRUE";
  if (t == token_type::KEYWORD_AND)
    return "KEYWORD_AND";
  if (t == token_type::KEYWORD_AS)
    return "KEYWORD_AS";
  if (t == token_type::KEYWORD_ASSERT)
    return "KEYWORD_ASSERT";
  if (t == token_type::KEYWORD_BREAK)
    return "KEYWORD_BREAK";
  if (t == token_type::KEYWORD_CCODE)
    return "KEYWORD_CCODE";
  if (t == token_type::KEYWORD_CLASS)
    return "KEYWORD_CLASS";
  if (t == token_type::KEYWORD_CONTINUE)
    return "KEYWORD_CONTINUE";
  if (t == token_type::KEYWORD_DEF)
    return "KEYWORD_DEF";
  if (t == token_type::KEYWORD_DEFER)
    return "KEYWORD_DEFER";
  if (t == token_type::KEYWORD_DEL)
    return "KEYWORD_DEL";
  if (t == token_type::KEYWORD_ELIF)
    return "KEYWORD_ELIF";
  if (t == token_type::KEYWORD_ELSE)
    return "KEYWORD_ELSE";
  if (t == token_type::KEYWORD_FOR)
    return "KEYWORD_FOR";
  if (t == token_type::KEYWORD_FROM)
    return "KEYWORD_FROM";
  if (t == token_type::KEYWORD_IF)
    return "KEYWORD_IF";
  if (t == token_type::KEYWORD_IMPORT)
    return "KEYWORD_IMPORT";
  if (t == token_type::KEYWORD_IN)
    return "KEYWORD_IN";
  if (t == token_type::KEYWORD_MACROS)
    return "KEYWORD_MACROS";
  if (t == token_type::KEYWORD_NOT)
    return "KEYWORD_NOT";
  if (t == token_type::KEYWORD_OR)
    return "KEYWORD_OR";
  if (t == token_type::KEYWORD_PASS)
    return "KEYWORD_PASS";
  if (t == token_type::KEYWORD_RETURN)
    return "KEYWORD_RETURN";
  if (t == token_type::KEYWORD_RUNTIMEFEATURE)
    return "KEYWORD_RUNTIMEFEATURE";
  if (t == token_type::KEYWORD_STRUCT)
    return "KEYWORD_STRUCT";
  if (t == token_type::KEYWORD_TRY)
    return "KEYWORD_TRY";
  if (t == token_type::KEYWORD_WHILE)
...
static inline token_type str_to_token(const std::string &t) {
  ...
  if (t == "AND_EQ")
    return token_type::AND_EQ;
  if (t == "ARROW")
    return token_type::ARROW;
  if (t == "AT")
    return token_type::AT;
  if (t == "BA_DEDENT")
    return token_type::BA_DEDENT;
  if (t == "BA_INDENT")
    return token_type::BA_INDENT;
  if (t == "COLON")
  ...
  if (t == "CURLY_BRACKET_CLOSE")
    return token_type::CURLY_BRACKET_CLOSE;
  if (t == "CURLY_BRACKET_OPEN")
    return token_type::CURLY_BRACKET_OPEN;
  if (t == "DIV")
    return token_type::DIV;
  if (t == "DIV_EQ")
    return token_type::DIV_EQ;
  if (t == "DOT")
  ...
  if (t == "EQ_EQ")
    return token_type::EQ_EQ;
  if (t == "FLOAT_NUMBER")
    return token_type::FLOAT_NUMBER;
  if (t == "GREAT")
    return token_type::GREAT;
  if (t == "GREAT_EQ")
    return token_type::GREAT_EQ;
  if (t == "INDENT")
  ...
  if (t == "INT_DIV")
    return token_type::INT_DIV;
  if (t == "INT_DIV_EQ")
    return token_type::INT_DIV_EQ;
  if (t == "LESS")
    return token_type::LESS;
  if (t == "LESS_EQ")
    return token_type::LESS_EQ;
  if (t == "MOD")
    return token_type::MOD;
  if (t == "MOD_EQ")
    return token_type::MOD_EQ;
  if (t == "MUL")
    return token_type::MUL;
  if (t == "MUL_EQ")
    return token_type::MUL_EQ;
  if (t == "NAME")
    return token_type::NAME;
  if (t == "NEW_LINE")
    return token_type::NEW_LINE;
  if (t == "NOT_EQ")
    return token_type::NOT_EQ;
  if (t == "NOT_SYMBOL")
    return token_type::NOT_SYMBOL;
  if (t == "OR")
    return token_type::OR;
  if (t == "OR_EQ")
    return token_type::OR_EQ;
  if (t == "PAREN_CLOSE")
  ...
  if (t == "PLUS_EQ")
    return token_type::PLUS_EQ;
  if (t == "POWER")
    return token_type::POWER;
  if (t == "POWER_EQ")
    return token_type::POWER_EQ;
  if (t == "SEMICOLON")
    return token_type::SEMICOLON;
  if (t == "SHL")
    return token_type::SHL;
  if (t == "SHL_EQ")
    return token_type::SHL_EQ;
  if (t == "SHR")
    return token_type::SHR;
  if (t == "SHR_EQ")
    return token_type::SHR_EQ;
  if (t == "SQUARE_BRACKET_CLOSE")
    return token_type::SQUARE_BRACKET_CLOSE;
  if (t == "SQUARE_BRACKET_OPEN")
    return token_type::SQUARE_BRACKET_OPEN;
  if (t == "STRING")
    return token_type::STRING;
  if (t == "SUB")
    return token_type::SUB;
  if (t == "SUB_EQ")
    return token_type::SUB_EQ;
  if (t == "THREE_QUOTE_STRING")
    return token_type::THREE_QUOTE_STRING;
  if (t == "TILDE")
    return token_type::TILDE;
  if (t == "UINTEGER_BIN")
    return token_type::UINTEGER_BIN;
  if (t == "UINTEGER_BIN_16")
    return token_type::UINTEGER_BIN_16;
  if (t == "UINTEGER_BIN_64")
    return token_type::UINTEGER_BIN_64;
  if (t == "UINTEGER_BIN_8")
    return token_type::UINTEGER_BIN_8;
  if (t == "UINTEGER_DECIMAL")
    return token_type::UINTEGER_DECIMAL;
  if (t == "UINTEGER_DECIMAL_16")
    return token_type::UINTEGER_DECIMAL_16;
  if (t == "UINTEGER_DECIMAL_64")
    return token_type::UINTEGER_DECIMAL_64;
  if (t == "UINTEGER_DECIMAL_8")
    return token_type::UINTEGER_DECIMAL_8;
  if (t == "UINTEGER_HEX")
    return token_type::UINTEGER_HEX;
  if (t == "UINTEGER_HEX_16")
    return token_type::UINTEGER_HEX_16;
  if (t == "UINTEGER_HEX_64")
    return token_type::UINTEGER_HEX_64;
  if (t == "UINTEGER_HEX_8")
    return token_type::UINTEGER_HEX_8;
  if (t == "UINTEGER_OCT")
    return token_type::UINTEGER_OCT;
  if (t == "UINTEGER_OCT_16")
    return token_type::UINTEGER_OCT_16;
  if (t == "UINTEGER_OCT_64")
    return token_type::UINTEGER_OCT_64;
  if (t == "UINTEGER_OCT_8")
    return token_type::UINTEGER_OCT_8;
  if (t == "UNKNOWN_BIN")
    return token_type::UNKNOWN_BIN;
  if (t == "UNKNOWN_DECIMAL")
    return token_type::UNKNOWN_DECIMAL;
  if (t == "UNKNOWN_HEX")
    return token_type::UNKNOWN_HEX;
  if (t == "UNKNOWN_OCT")
    return token_type::UNKNOWN_OCT;
  if (t == "XOR")
    return token_type::XOR;
  if (t == "XOR_EQ")
    return token_type::XOR_EQ;
  if (t == "KEYWORD_FALSE")
    return token_type::KEYWORD_FALSE;
  if (t == "KEYWORD_NONE")
    return token_type::KEYWORD_NONE;
  if (t == "KEYWORD_TRUE")
    return token_type::KEYWORD_TRUE;
  if (t == "KEYWORD_AND")
    return token_type::KEYWORD_AND;
  if (t == "KEYWORD_AS")
    return token_type::KEYWORD_AS;
  if (t == "KEYWORD_ASSERT")
    return token_type::KEYWORD_ASSERT;
  if (t == "KEYWORD_BREAK")
    return token_type::KEYWORD_BREAK;
  if (t == "KEYWORD_CCODE")
    return token_type::KEYWORD_CCODE;
  if (t == "KEYWORD_CLASS")
    return token_type::KEYWORD_CLASS;
  if (t == "KEYWORD_CONTINUE")
    return token_type::KEYWORD_CONTINUE;
  if (t == "KEYWORD_DEF")
    return token_type::KEYWORD_DEF;
  if (t == "KEYWORD_DEFER")
    return token_type::KEYWORD_DEFER;
  if (t == "KEYWORD_DEL")
    return token_type::KEYWORD_DEL;
  if (t == "KEYWORD_ELIF")
    return token_type::KEYWORD_ELIF;
  if (t == "KEYWORD_ELSE")
    return token_type::KEYWORD_ELSE;
  if (t == "KEYWORD_FOR")
    return token_type::KEYWORD_FOR;
  if (t == "KEYWORD_FROM")
    return token_type::KEYWORD_FROM;
  if (t == "KEYWORD_IF")
    return token_type::KEYWORD_IF;
  if (t == "KEYWORD_IMPORT")
    return token_type::KEYWORD_IMPORT;
  if (t == "KEYWORD_IN")
    return token_type::KEYWORD_IN;
  if (t == "KEYWORD_MACROS")
    return token_type::KEYWORD_MACROS;
  if (t == "KEYWORD_NOT")
    return token_type::KEYWORD_NOT;
  if (t == "KEYWORD_OR")
    return token_type::KEYWORD_OR;
  if (t == "KEYWORD_PASS")
    return token_type::KEYWORD_PASS;
  if (t == "KEYWORD_RETURN")
    return token_type::KEYWORD_RETURN;
  if (t == "KEYWORD_RUNTIMEFEATURE")
    return token_type::KEYWORD_RUNTIMEFEATURE;
  if (t == "KEYWORD_STRUCT")
    return token_type::KEYWORD_STRUCT;
  if (t == "KEYWORD_TRY")
    return token_type::KEYWORD_TRY;
  if (t == "KEYWORD_WHILE")
...
return (t == token_type::DOUBLE_NUMBER || t == token_type::FLOAT_NUMBER || t == token_type::INTEGER_BIN || t == token_type::INTEGER_BIN_16 || t == token_type::INTEGER_BIN_64 || t == token_type::INTEGER_BIN_8 || t == token_type::INTEGER_DECIMAL || t == token_type::INTEGER_DECIMAL_16 || t == token_type::INTEGER_DECIMAL_64 || t == token_type::INTEGER_DECIMAL_8 || t == token_type::INTEGER_HEX || t == token_type::INTEGER_HEX_16 || t == token_type::INTEGER_HEX_64 || t == token_type::INTEGER_HEX_8 || t == token_type::INTEGER_OCT || t == token_type::INTEGER_OCT_16 || t == token_type::INTEGER_OCT_64 || t == token_type::INTEGER_OCT_8 || t == token_type::UINTEGER_BIN || t == token_type::UINTEGER_BIN_16 || t == token_type::UINTEGER_BIN_64 || t == token_type::UINTEGER_BIN_8 || t == token_type::UINTEGER_DECIMAL || t == token_type::UINTEGER_DECIMAL_16 || t == token_type::UINTEGER_DECIMAL_64 || t == token_type::UINTEGER_DECIMAL_8 || t == token_type::UINTEGER_HEX || t == token_type::UINTEGER_HEX_16 || t == token_type::UINTEGER_HEX_64 || t == token_type::UINTEGER_HEX_8 || t == token_type::UINTEGER_OCT || t == token_type::UINTEGER_OCT_16 || t == token_type::UINTEGER_OCT_64 || t == token_type::UINTEGER_OCT_8);
}
